...
const BLOG_POSTS = [
  ...
  },
  {
    ...
    "content": [
      ...
      "<ul><li><strong>Absolute Clarity</strong> — any student can start studying at any given time and know exactly what to do next, no excuse. This is the idea the <a href=\"blog-post.html?slug=how-to-use-zenith\">Portal</a> exists to deliver: one system, one source of truth for your roadmap, feedback, and calendar.</li><li><strong>Inner Excellence</strong> — beyond the curriculum, who you become while chasing the score matters just as much as the score itself: process over outcome, quiet discipline, humility.</li><li><strong>Community</strong> — you don't have to feel lost. Direct, ongoing guidance from real people, not a one-time consultation or a static curriculum.</li></ul>",
